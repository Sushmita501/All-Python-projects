...
print(f"Hare Krishna {name} welcome to this adventure!")
...
if answer == "left":
   ...
   answer = input("You come to a bridge, it looks wobbly, do you want to cross it or hand back (cross/back)? ").lower()
